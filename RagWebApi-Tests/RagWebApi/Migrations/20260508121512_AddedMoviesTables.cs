...
{
    /// <inheritdoc />
    public partial class AddedMoviesTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Homepage = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Language = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Title = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Overview = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: false),
                    Popularity = table.Column<double>(type: "float", nullable: false),
                    ProductionCountries = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Revenue = table.Column<double>(type: "float", nullable: false),
                    Runtime = table.Column<int>(type: "int", nullable: false),
                    LanguageSpoken = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Tagline = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    ...
                    Embeddings = table.Column<string>(type: "NVARCHAR(MAX)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Movies_Actors_DirectorId",
